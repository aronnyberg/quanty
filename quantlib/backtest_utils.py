...
def run_strategy_classifier(database_df, strat_df, run_live_classifier):
    #database_df.set_index('date', inplace=True)
    database_df = database_df.pct_change()
    ...
    X, y = classifier_data_transform(database_df.tail(1), strat_df.tail(1))
